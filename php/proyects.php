...
<body>
                ...
                <div class="col-12 col-md-8" id="contenedor-general-padding">
                    ...
                    <div id="contenedor__general">
                        ...
                        <div class="col-12 d-flex" id="selector__galeria">
                            <button onclick="setSelector('todo')" class="col-3 selector activo d-flex justify-content-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                    <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                                </svg>
                                Todas
                            </button>
                            <button onclick="setSelector('landing')" class="col-3 selector d-flex justify-content-center">
                            ...
                            <button onclick="setSelector('web')" class="col-3 selector d-flex justify-content-center">
                            ...
                            <button onclick="setSelector('ecommerce')" class="col-3 selector d-flex justify-content-center">
    ...
    <script>
        ...
        function muestraProyectos(){
            fetch("/php/muestraTablas.php").then(res=>{
                return res.text();
            }).then(data=>{
                if(data == 'no_more_projects'){
                    observador.disconnect();
                }else{
                    galeria.innerHTML += data;
                    const proyectos = document.querySelectorAll(".contenedor__proyecto");
                    if(proyectos.length > 0){
                        const ultimoProyecto = proyectos.length - 1;
                        observador.observe(proyectos[ultimoProyecto]);
                    }
                }
            }).catch(err=>{
                console.log(err);
        ...
        function setSelector(opc){
            galeria.innerHTML = '';
            fetch("setSelector.php?selector="+opc).then(()=>{
                muestraProyectos();
            }).catch(err=>{
                console.log(err);
            })
