...
<body>
    <div id="page">
        <header>
            <div id="contenedorNavs">
                ...
                <nav id="nav2" class="container-fluid d-flex">
                    <div class="d-flex align-items-center" style="width:15rem;">
        ...
        <main>
            ...
            <div id="contenedorVideoInicial" class="position-absolute w-100 vh-100 bg-dark">
                ...
                <div id="contenedorInicial" class="d-flex flex-column justify-content-center flex-grow-1">
                    <div class="container-fluid mt-5">
                        ...
                        <div class="container mt-md-5 mt-3">
                            <div class="row">
                                <div id="redesInicial" class="col-12 col-md-6 d-flex justify-content-around">
                    ...
                    <div class="row">
                        ...
                        <div id="contenedorInformacionConocenos" class="mt-3 mt-md-0 col-12 col-md-5 position-relative">
                            <div class="infoConocenos">
                                <h3 class="tituloConocenos tituloFuente">Tu puerta al mundo digital</h3>
                            ...
                            <div class="infoConocenos d-none">
                                <h3 class="tituloConocenos tituloFuente">Diseño web que marca la diferencia</h3>
                                <p class="textoConocenos">
                            ...
                            <div class="infoConocenos d-none">
                                <h3 class="tituloConocenos tituloFuente">Diseñando tu éxito en la web</h3>
                                <p class="textoConocenos">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="row my-4 rowHerramientas">
                                ...
                                <div class="col-4 d-flex flex-column align-items-center">
                                    <h4>Inkscape</h4>
                                    <img class="svgLogo" src="/src/img/inkscapeLogo.svg" alt="inkscape logo">
                                </div>
                                <div class="col-4 d-flex flex-column align-items-center">
                                    <h4></h4>
                                </div>
                            ...
                            <div class="row my-4 rowHerramientas">
                                ...
                                <div class="col-4 d-flex flex-column align-items-center">
                                    <h4>Lightroom</h4>
                                    <img class="svgLogo" src="/src/img/lightroomLogo.svg" alt="lightroom logo">
                                </div>
                                <div class="col-4 d-flex flex-column align-items-center">
                                    <h4>Photoshop</h4>
                                    <img class="svgLogo" src="/src/img/photoshopLogo.svg" alt="photoshop logo">
                                </div>
                            </div>
                        </div>
                ...
                <div style="position:relative; z-index:2;">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-center">
                                    <h2 class="titulo tituloFuente tituloSeparadorBlanco">Nuestros precios</h2>
                                </div>
                            ...
                            <div class="position-absolute" style="height:200%; top:-100%; width:100%; left:0;">
                                <div class="" id="contenedorImagenContacto" style="height:50%;position:sticky;top:10vh;" class="bg-warning">
                                    ...
                                    <video id="videoFormulario" muted loop autoplay>
                                        <source src="/src/img/gatoVideo.webm" type="video/webm">
                                    </video>
                                </div>
                            </div>
                        </div>
